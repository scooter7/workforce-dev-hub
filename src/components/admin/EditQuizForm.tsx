...
const EditQuizForm: React.FC<EditQuizFormProps> = ({ topics, quiz }) => {
  ...
  const [selectedImageUrl, setSelectedImageUrl] = useState<string | null>(quiz.card_image_url || null);
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 bg-white p-8 rounded-lg shadow-md">
      ...
      <div className="flex justify-end pt-4">
        ...
        <Button type="submit" disabled={isSubmitting || !selectedImageUrl} className="ml-3">
